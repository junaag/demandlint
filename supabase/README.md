...
```html
<img src="https://demandlint.com/brand/demandlint-logo-email.png" width="240" height="56" alt="DemandLint" style="display:block;width:240px;max-width:100%;height:auto;border:0;outline:none;text-decoration:none;">
