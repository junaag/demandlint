...
export function ExportMethodChoice({ template, method, onChange }: { template: ExportTemplate; method: ExportMethod; onChange: (method: ExportMethod) => void }) {
  ...
  return <section className="export-method-choice" aria-labelledby="export-method-title">
    <div className="workflow-section-heading"><span>EXPORT METHOD</span><h3 id="export-method-title">Export method</h3></div>
